...
export const Formats: FormatList = [
	...
	{
		section: "Eelda's League",
	},
	{
		name: "[Gen 8] Eelda's OU",
		threads: [
	...
	// {
	// 	name: "[Gen 8] Eelda's VGC 2021 (Series 9)",

	// 	mod: 'gen8',
	// 	gameType: 'doubles',
	// 	ruleset: ['Flat Rules', '!! Adjust Level Down = 50', 'Min Source Gen = 8', 'VGC Timer'],
	// },
	{
		name: "[Gen 8] Eelda's VGC 2021 (Series 10)",
		mod: 'gen8',
		gameType: 'doubles',
		forcedLevel: 50,
		teamLength: {
		...
		ruleset: ['Single Restricted GBU', 'VGC Timer', 'Dynamax Clause'],
		minSourceGen: 8,
	},
	{
		name: "[Gen 8] New Species VGC",
		forcedLevel: 50,
                teamLength: {
                        validate: [4, 6],
                        battle: 4,
		...
		mod: 'gen8',
		gameType: 'doubles',
		ruleset: ['VGC Timer', 'Team Preview', 'Species Clause', 'Nickname Clause', 'Item Clause', 'Cancel Mod', 'Evasion Moves Clause', 'Standard NatDex', 'Dynamax Clause'],
	},
	{
		name: "Eelda's Multi Random Battle",
